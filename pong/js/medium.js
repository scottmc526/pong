...
var graphicAssets = {
  ballURL: 'assets/svg/ball_gray.svg',
  ballName: 'ball',
...
var fontAssets = {
  ...
  scoreFontStyle: {font: '80px Impact', fill: '#FFFFFF', align: 'center'},
}
...
mainState.prototype = {
    ...
    create: function () {
      ...
      this.initKeyboard();
      this.startDemo();
      game.stage.backgroundColor = '#f7901e';
    ...
    initGraphics: function() {
      ...
      this.paddleLeftSprite.scale.setTo(1, 2.5);
      ...
      this.paddleRightSprite.scale.setTo(1, 2.5);
